...
$(document).ready(function() {
    ...
    if (searchEngine == "google") {
        search = "httpss://www.google.com/search"
    } else {
        if (searchEngine == "bing") {
            search = "httpss://www.bing.com/search"
        } else {
            if (searchEngine == "sogou") {
                search = "httpss://www.sogou.com/sogou"
            } else {
                search = "httpss://www.google.com/search";
                searchEngine = "google"
            }
    ...
    $("#google1").click(function() {
        $("#wrapper1 form").attr("action", "httpss://www.google.com/search");
        $("#engines1").fadeToggle("fast", "circEaseOut");
    ...
    $("#bing1").click(function() {
        $("#wrapper1 form").attr("action", "httpss://www.bing.com/search");
        $("#engines1").fadeToggle("fast", "circEaseOut");
    ...
    $("#sogou1").click(function() {
        $("#wrapper1 form").attr("action", "httpss://www.sogou.com/sogou");
        $("#engines1").fadeToggle("fast", "circEaseOut");
    ...
    $("#baidu1").click(function() {
        $("#wrapper1 form").attr("action", "httpss://www.baidu.com/s");
    ...
    if (G > 1) {
        ...
        $("#google2").click(function() {
            $("#wrapper2 form").attr("action", "httpss://www.google.com/search");
            $("#engines2").fadeToggle("fast", "circEaseOut");
        ...
        $("#bing2").click(function() {
            $("#wrapper2 form").attr("action", "httpss://www.bing.com/search");
            $("#engines2").fadeToggle("fast", "circEaseOut");
        ...
        $("#sogou2").click(function() {
            $("#wrapper2 form").attr("action", "httpss://www.sogou.com/sogou");
            $("#engines2").fadeToggle("fast", "circEaseOut");
        ...
        $("#baidu2").click(function() {
            $("#wrapper2 form").attr("action", "httpss://www.baidu.com/s");
    ...
    if (G > 2) {
        ...
        $("#google3").click(function() {
            $("#wrapper3 form").attr("action", "httpss://www.google.com/search");
            $("#engines3").fadeToggle("fast", "circEaseOut");
        ...
        $("#bing3").click(function() {
            $("#wrapper3 form").attr("action", "httpss://www.bing.com/search");
            $("#engines3").fadeToggle("fast", "circEaseOut");
        ...
        $("#sogou3").click(function() {
            $("#wrapper3 form").attr("action", "httpss://www.sogou.com/sogou");
            $("#engines3").fadeToggle("fast", "circEaseOut");
        ...
        $("#baidu3").click(function() {
            $("#wrapper3 form").attr("action", "httpss://www.baidu.com/s");
    ...
    if (G > 3) {
        ...
        $("#google4").click(function() {
            $("#wrapper4 form").attr("action", "httpss://www.google.com/search");
            $("#engines4").fadeToggle("fast", "circEaseOut");
        ...
        $("#bing4").click(function() {
            $("#wrapper4 form").attr("action", "httpss://www.bing.com/search");
            $("#engines4").fadeToggle("fast", "circEaseOut");
        ...
        $("#sogou4").click(function() {
            $("#wrapper4 form").attr("action", "httpss://www.sogou.com/sogou");
            $("#engines4").fadeToggle("fast", "circEaseOut");
        ...
        $("#baidu4").click(function() {
            $("#wrapper4 form").attr("action", "httpss://www.baidu.com/s");
    ...
    if (G > 4) {
        ...
        $("#google5").click(function() {
            $("#wrapper5 form").attr("action", "httpss://www.google.com/search");
            $("#engines5").fadeToggle("fast", "circEaseOut");
        ...
        $("#bing5").click(function() {
            $("#wrapper5 form").attr("action", "httpss://www.bing.com/search");
            $("#engines5").fadeToggle("fast", "circEaseOut");
        ...
        $("#sogou5").click(function() {
            $("#wrapper5 form").attr("action", "httpss://www.sogou.com/sogou");
            $("#engines5").fadeToggle("fast", "circEaseOut");
        ...
        $("#baidu5").click(function() {
            $("#wrapper5 form").attr("action", "httpss://www.baidu.com/s");
    ...
    if (G > 5) {
        ...
        $("#google6").click(function() {
            $("#wrapper6 form").attr("action", "httpss://www.google.com/search");
            $("#engines6").fadeToggle("fast", "circEaseOut");
        ...
        $("#bing6").click(function() {
            $("#wrapper6 form").attr("action", "httpss://www.bing.com/search");
            $("#engines6").fadeToggle("fast", "circEaseOut");
        ...
        $("#sogou6").click(function() {
            $("#wrapper6 form").attr("action", "httpss://www.sogou.com/sogou");
            $("#engines6").fadeToggle("fast", "circEaseOut");
        ...
        $("#baidu6").click(function() {
            $("#wrapper6 form").attr("action", "httpss://www.baidu.com/s");
    ...
    if (G > 6) {
        ...
        $("#google7").click(function() {
            $("#wrapper7 form").attr("action", "httpss://www.google.com/search");
            $("#engines7").fadeToggle("fast", "circEaseOut");
        ...
        $("#bing7").click(function() {
            $("#wrapper7 form").attr("action", "httpss://www.bing.com/search");
            $("#engines7").fadeToggle("fast", "circEaseOut");
        ...
        $("#sogou7").click(function() {
            $("#wrapper7 form").attr("action", "httpss://www.sogou.com/sogou");
            $("#engines7").fadeToggle("fast", "circEaseOut");
        ...
        $("#baidu7").click(function() {
            $("#wrapper7 form").attr("action", "httpss://www.baidu.com/s");
    ...
    if (G > 7) {
        ...
        $("#google8").click(function() {
            $("#wrapper8 form").attr("action", "httpss://www.google.com/search");
            $("#engines8").fadeToggle("fast", "circEaseOut");
        ...
        $("#bing8").click(function() {
            $("#wrapper8 form").attr("action", "httpss://www.bing.com/search");
            $("#engines8").fadeToggle("fast", "circEaseOut");
        ...
        $("#sogou8").click(function() {
            $("#wrapper8 form").attr("action", "httpss://www.sogou.com/sogou");
            $("#engines8").fadeToggle("fast", "circEaseOut");
        ...
        $("#baidu8").click(function() {
            $("#wrapper8 form").attr("action", "httpss://www.baidu.com/s");
    ...
    if (G > 8) {
        ...
        $("#google9").click(function() {
            $("#wrapper9 form").attr("action", "httpss://www.google.com/search");
            $("#engines9").fadeToggle("fast", "circEaseOut");
        ...
        $("#bing9").click(function() {
            $("#wrapper9 form").attr("action", "httpss://www.bing.com/search");
            $("#engines9").fadeToggle("fast", "circEaseOut");
        ...
        $("#sogou9").click(function() {
            $("#wrapper9 form").attr("action", "httpss://www.sogou.com/sogou");
            $("#engines9").fadeToggle("fast", "circEaseOut");
        ...
        $("#baidu9").click(function() {
            $("#wrapper9 form").attr("action", "httpss://www.baidu.com/s");
...
bookmark[0][0] = {
    title: "网易",
    url: "httpss://www.163.com",
    thumb: "163.png"
};
bookmark[0][1] = {
    title: "腾讯网",
    url: "httpss://www.qq.com/",
    thumb: "qq.png"
};
bookmark[0][2] = {
    title: "搜狐",
    url: "httpss://www.sohu.com",
    thumb: "sohu.png"
};
bookmark[0][3] = {
    title: "新浪网",
    url: "httpss://www.sina.com.cn/",
    thumb: "sina.png"
};
bookmark[0][4] = {
    title: "豆瓣",
    url: "httpss://www.douban.com",
    thumb: "douban.png"
};
bookmark[0][5] = {
    title: "新浪微博",
    url: "httpss://weibo.com/?c=spr_web_sq_6164_weibo_t001",
    thumb: "weibo.png"
};
bookmark[0][6] = {
    title: "人人网",
    url: "httpss://www.renren.com",
    thumb: "renren.png"
};
bookmark[0][7] = {
    title: "央视网",
    url: "httpss://www.cctv.com",
    thumb: "cctv.png"
};
bookmark[0][8] = {
    title: "QQ空间",
    url: "httpss://qzone.qq.com",
    thumb: "qzone.png"
};
bookmark[0][9] = {
    title: "优酷",
    url: "httpss://www.youku.com",
    thumb: "youku.png"
};
bookmark[0][10] = {
    title: "凤凰网",
    url: "httpsss://www.ifeng.com",
    thumb: "ifeng.png"
};
bookmark[0][11] = {
    title: "3399小游戏",
    url: "httpss://www.3399.com/?fr=10009-1",
    thumb: "3399.png"
};
bookmark[1][0] = {
    title: "苏宁",
    url: "httpss://p.yiqifa.com/c?s=25ffbe45&w=253302&c=4459&i=5662&l=0&e=win8-1&t=httpss://www.suning.com/",
    thumb: "suning.png"
};
bookmark[1][1] = {
    title: "易迅",
    url: "httpss://p.yiqifa.com/c?s=9289bf39&w=253302&c=4330&i=4984&l=0&e=win8-1&t=httpss://www.yixun.com",
    thumb: "51buy.png"
};
bookmark[1][2] = {
    title: "一号店",
    url: "httpss://p.yiqifa.com/c?s=ea58a335&w=253302&c=139&i=802&l=0&e=win8-1&t=httpss://www.yhd.com/",
    thumb: "yihaodian.png"
};
bookmark[1][3] = {
    title: "唯品会",
    url: "httpss://p.yiqifa.com/c?s=ea3b031c&w=253302&c=4018&i=2882&l=0&e=win8-1&t=httpss://www.vip.com/",
    thumb: "vipshop.png"
};
bookmark[1][4] = {
    title: "当当",
    url: "httpss://p.yiqifa.com/c?s=a2a2a463&w=253302&c=247&i=159&l=0&e=win8-1&t=httpss://www.dangdang.com",
    thumb: "dangdang.png"
};
bookmark[1][5] = {
    title: "京东",
    url: "httpss://p.yiqifa.com/c?s=5308bddc&w=253302&c=254&i=160&l=0&e=win8-1&t=httpss://www.jd.com",
    thumb: "360buy.png"
};
bookmark[1][6] = {
    title: "亚马逊",
    url: "httpss://www.amazon.cn?tag=eqifa180-23&ascsubtag=253302|1|win8-1",
    thumb: "amazon.png"
};
bookmark[1][7] = {
    title: "凡客",
    url: "httpss://www.vancl.com/?source=divencheng",
    thumb: "vancl.png"
};
bookmark[1][8] = {
    title: "好乐买",
    url: "httpss://p.yiqifa.com/c?s=38d8631c&w=253302&c=5820&i=15862&l=0&e=win8-1&t=httpss://www.yougou.com/",
    thumb: "okbuy.png"
};
bookmark[1][9] = {
    title: "爱淘宝",
    url: "httpss://ai.taobao.com?pid=mm_16596268_4688103_15820839",
    thumb: "taobao.png"
};
bookmark[1][10] = {
    title: "天猫",
    url: "httpss://s.click.taobao.com/t?e=zGU34CA7K%2BPkqB05%2Bm7rfGGjlY60oHcc7bkKOQiRddrNEyGLx31dnc6%2Fz%2BaQS2UNDUWpebTcEEjBuk1W5odmLS8%3D&pid=mm_16596268_4688103_15838003",
    thumb: "tmall.png"
};
bookmark[1][11] = {
    title: "梦芭莎",
    url: "httpss://p.yiqifa.com/c?s=4f5f315d&w=253302&c=298&i=323&l=0&e=win8-1&t=httpss://www.moonbasa.com/",
    thumb: "moonbasa.png"
};
bookmark[2][0] = {
    title: "花瓣网",
    url: "httpss://huaban.com/",
    thumb: "huaban.png"
};
bookmark[2][1] = {
    title: "音悦Tai",
    url: "httpss://www.yinyuetai.com/",
    thumb: "yinyuetai.png"
};
bookmark[2][2] = {
    title: "豆瓣电台",
    url: "httpss://douban.fm/",
    thumb: "doubanfm.png"
};
bookmark[2][3] = {
    title: "悦读FM",
...
bookmark[2][6] = {
    title: "瘾科技",
    url: "httpss://cn.engadget.com/",
    thumb: "engadget.png"
};
bookmark[2][7] = {
    title: "时光电影",
    url: "httpss://www.mtime.com/",
    thumb: "mtime.png"
};
bookmark[2][8] = {
    title: "糗事百科",
    url: "httpss://www.qiushibaike.com/",
    thumb: "qiushibaike.png"
};
bookmark[2][9] = {
    title: "book",
    url: "httpss://book.6164.com/",
    thumb: "book.png"
};
bookmark[2][10] = {
    title: "TOPIT.ME",
...
bookmark[2][11] = {
    title: "V电影",
    url: "httpss://v.6164.com/",
    thumb: "vmovier.png"
};
bookmark[3][0] = {
    title: "知乎",
    url: "httpss://www.zhihu.com/",
    thumb: "zhihu.png"
};
bookmark[3][1] = {
    title: "煎蛋",
    url: "httpss://jandan.net/",
    thumb: "jandan.png"
};
bookmark[3][2] = {
    title: "爱库",
    url: "httpss://www.ikeepu.com/",
    thumb: "ikeepu.png"
};
bookmark[3][3] = {
    title: "微盘",
...
bookmark[3][4] = {
    title: "乐活户外",
    url: "httpss://p.yiqifa.com/c?s=1e8194d0&w=253302&c=5588&i=14382&l=0&e=win8-1&t=httpss://www.m360.com.cn",
    thumb: "m360.png"
};
bookmark[3][5] = {
    title: "趣玩",
    url: "httpss://p.yiqifa.com/c?s=8e9d9737&w=253302&c=1800&i=1362&l=0&e=win8-1&t=httpss://www.quwan.com",
    thumb: "quwan.png"
};
bookmark[3][6] = {
    title: "佑一良品",
    url: "httpss://p.yiqifa.com/c?s=0f0c7283&w=253302&c=5390&i=11702&l=0&e=win8-1&t=httpss://www.uiyi.cn/",
    thumb: "uiyi.png"
};
bookmark[3][7] = {
    title: "百度文库",
    url: "httpss://wenku.baidu.com/",
    thumb: "wenku.png"
};
bookmark[3][8] = {
    title: "堆糖",
    url: "httpss://www.duitang.com/",
    thumb: "duitang.png"
};
bookmark[3][9] = {
    title: "巨有趣",
    url: "httpss://www.juyouqu.com/",
    thumb: "juyouqu.png"
};
bookmark[3][10] = {
    title: "蘑菇街",
    url: "httpss://www.mogujie.com/trade/click?c=19&u=12gkkr4&t=httpss%3A%2F%2Fwww.mogujie.com",
    thumb: "mogujie.png"
};
bookmark[3][11] = {
    title: "美丽说",
    url: "httpss://www.meilishuo.com/welcome?frm=NM_s10094",
    thumb: "meilishuo.png"
};
bookmark[4][0] = {
    title: "聚划算",
    url: "httpss://s.click.taobao.com/t?e=zGU34CA7K%2BPkqB05%2Bm7rfGKas1PIKp0U37pZuBotzOg7OjeU9mIWS5%2B5UROBz6sq4fiHePnGhf6UrWuOtfD2G6QGcAHIXpjhEtESpuqsRo0a&pid=mm_16596268_4688103_15820839",
    thumb: "juhuasuan.png"
};
bookmark[4][1] = {
    title: "豆果美食",
    url: "httpss://www.douguo.com/",
    thumb: "douguo.png"
};
bookmark[4][2] = {
    title: "百姓网",
    url: "httpss://www.baixing.com/",
    thumb: "baixing.png"
};
bookmark[4][3] = {
    title: "口碑网",
    url: "httpss://www.koubei.com/",
    thumb: "koubei.png"
};
bookmark[4][4] = {
    title: "58同城",
    url: "httpss://www.58.com/",
    thumb: "58.png"
};
bookmark[4][5] = {
    title: "赶集网",
    url: "httpss://www.ganji.com/",
    thumb: "ganji.png"
};
bookmark[4][6] = {
    title: "下厨房",
    url: "httpss://www.xiachufang.com",
    thumb: "xiachufang.png"
};
bookmark[4][7] = {
    title: "美团",
    url: "httpss://p.yiqifa.com/c?s=3c1c7cd0&w=253302&c=5402&i=11642&l=0&e=win8-1&t=httpss://bj.meituan.com/",
    thumb: "meituan.png"
};
bookmark[4][8] = {
    title: "前程无忧",
    url: "httpss://my.51job.com/my/trace.php?adsnum=19423&ajp=aHR0cDovL3d3dy41MWpvYi5jb20v",
    thumb: "51job.png"
};
bookmark[4][9] = {
    title: "智联招聘",
    url: "httpss://www.zhaopin.com/",
    thumb: "zhaopin.png"
};
bookmark[4][10] = {
    title: "金象网",
    url: "httpss://p.yiqifa.com/c?s=4bab3b89&w=253302&c=305&i=225&l=0&e=win8-1&t=httpss://www.jxdyf.com",
    thumb: "jxdyf.png"
};
bookmark[4][11] = {
    title: "大众点评网",
    url: "httpss://www.dianping.com/",
    thumb: "dianping.png"
};
bookmark[5][0] = {
    title: "ibm developerworks",
    url: "httpss://www.ibm.com/developerworks/cn/",
    thumb: "developerworks.png"
};
bookmark[5][1] = {
    title: "Google Code",
    url: "httpss://code.google.com/hosting/",
    thumb: "google-code.png"
};
bookmark[5][2] = {
    title: "蓝色理想",
    url: "httpss://www.blueidea.com/",
    thumb: "blueidea.png"
};
bookmark[5][3] = {
    title: "阳春非凡",
    url: "httpss://www.ycff.com/",
    thumb: ""
};
bookmark[5][4] = {
    title: "开源中国社区",
    url: "httpss://www.oschina.net/",
    thumb: "oschina.png"
};
bookmark[5][5] = {
    title: "GitHub",
    url: "httpsss://github.com/",
    thumb: "github.png"
};
bookmark[5][6] = {
    title: "sourceforge",
    url: "httpss://sourceforge.net/",
    thumb: "sourceforge.png"
};
bookmark[5][7] = {
    title: "high scalability",
    url: "httpss://highscalability.com/",
    thumb: "highscalability.png"
};
bookmark[5][8] = {
    title: "scriptmafia",
    url: "httpss://www.scriptmafia.com/",
    thumb: "scriptmafia.png"
};
bookmark[5][9] = {
    title: "infoq",
    url: "httpss://www.infoq.com/",
    thumb: "infoq.png"
};
bookmark[5][10] = {
    title: "CSDN",
    url: "httpss://www.csdn.net/",
    thumb: "csdn.png"
};
bookmark[5][11] = {
    title: "BitBucket",
    url: "httpsss://bitbucket.org/",
    thumb: "bitbucket.png"
};
bookmark[6][0] = {
    title: "myfonts",
    url: "httpss://www.myfonts.com/WhatTheFont/",
    thumb: "myfonts.png"
};
bookmark[6][1] = {
    title: "365PSD",
    url: "httpss://365psd.com/",
    thumb: "365psd.png"
};
bookmark[6][2] = {
    title: "icon finder",
    url: "httpss://www.iconfinder.com/",
    thumb: "iconfinder.png"
};
bookmark[6][3] = {
    title: "ucdChina",
    url: "httpss://www.ucdchina.com/",
    thumb: "ucdchina.png"
};
bookmark[6][4] = {
    title: "猪八戒",
    url: "httpss://un.zhubajie.com/r/?u=6763674&l=httpss://www.zhubajie.com/",
    thumb: "zhubajie.png"
};
bookmark[6][5] = {
    title: "dribbble",
    url: "httpss://dribbble.com/",
    thumb: "dribbble.png"
};
bookmark[6][6] = {
    title: "500px",
    url: "httpss://500px.com/",
    thumb: "500px.png"
};
bookmark[6][7] = {
    title: "设计共和国",
    url: "httpss://www.rologo.com/",
    thumb: "rologo.png"
};
bookmark[6][8] = {
    title: "设计日报",
    url: "httpss://www.designdaily.cn/",
    thumb: "designdaily.png"
};
bookmark[6][9] = {
    title: "deviantart",
    url: "httpss://www.deviantart.com/",
    thumb: "deviantart.png"
};
bookmark[6][10] = {
    title: "全球设计精选站",
    url: "httpss://designlol.net/",
    thumb: "designlol.png"
};
bookmark[6][11] = {
    title: "where we design",
    url: "httpss://wherewedesign.com/",
    thumb: "wherewedesign.png"
};
bookmark[7][0] = {
    title: "淘宝旅行",
    url: "httpss://s.click.taobao.com/t?e=zGU34CA7K%2BPkqB05%2Bm7rfGKas1PIKp0U37pZuBotzOg7OjY%2F2R0Ke3HHzv2kJZUH%2FehqodvBvxouiCPW7UkqmIn4pk08catp7aU2wpqfONSeQJM%3D&pid=mm_16596268_4688103_15820839",
    thumb: "taobaotrip.png"
};
bookmark[7][1] = {
    title: "7天连锁酒店",
    url: "httpss://p.yiqifa.com/c?s=5e3a2b70&w=253302&c=7112&i=37909&l=0&e=win8-1&t=httpss://e.7daysinn.cn/market/track.php",
    thumb: "7daysinn.png"
};
bookmark[7][2] = {
    title: "悠哉旅游网",
    url: "httpss://p.yiqifa.com/c?s=6d9eafeb&w=253302&c=5528&i=13362&l=0&e=win8-1&t=httpss://www.uzai.com",
    thumb: "uzai.png"
};
bookmark[7][3] = {
    title: "酷讯机票",
    url: "httpss://p.yiqifa.com/n?k=2mLErn2O6l2SrI6H2mLErI6H6ljlWmLmWE3m1N6HWlzL6EzlrtsZR7oCpQqerI6H3EXwWEyy6JgH2L--&e=win8-1&spm=1.1.1.1&t=httpss://www.kuxun.cn",
    thumb: "kuxun.png"
};
bookmark[7][4] = {
    title: "携程",
    url: "httpss://p.yiqifa.com/c?s=72ab52bc&w=253302&c=297&i=19323&l=0&d=2756&e=win8-1&t=httpss://u.ctrip.com/union/redirect.aspx",
    thumb: "ctrip.png"
};
bookmark[7][5] = {
    title: "驴妈妈",
    url: "httpss://p.yiqifa.com/c?s=a57c7b5a&w=253302&c=5740&i=16722&l=0&e=win8-1&t=httpss://www.lvmama.com",
    thumb: "lvmama.png"
};
bookmark[7][6] = {
    title: "艺龙",
    url: "httpss://p.yiqifa.com/c?s=f3b2afae&w=253302&c=276&i=25842&l=0&e=win8-1&t=httpss://travel.elong.com/hotel/",
    thumb: "elong.png"
};
bookmark[7][7] = {
    title: "布丁酒店连锁",
    url: "httpss://p.yiqifa.com/c?s=3f420231&w=253302&c=6370&i=18562&l=0&e=win8-1&t=httpss://www.podinns.com/",
    thumb: "podinns.png"
};
bookmark[7][8] = {
    title: "住哪网",
    url: "httpss://p.yiqifa.com/c?s=f4ee47e1&w=253302&c=5491&i=12582&l=0&e=win8-1&t=httpss://www.zhuna.cn/",
    thumb: "zhuna.png"
};
bookmark[7][9] = {
    title: "同程网",
    url: "httpss://p.yiqifa.com/c?s=15f50b00&w=253302&c=7036&i=27402&l=0&e=win8-1&t=httpss://www.17u.cn",
    thumb: "17u.png"
};
bookmark[7][10] = {
    title: "铁友网",
    url: "httpss://p.yiqifa.com/c?s=26390d3a&w=253302&c=6451&i=19382&l=0&e=win8-1&t=httpss://tj.tieyou.com/gw.php",
    thumb: "tieyou.png"
};
bookmark[7][11] = {
    title: "芒果网",
    url: "httpss://p.yiqifa.com/c?s=ff90ab53&w=253302&c=5112&i=9542&l=0&e=win8-1&t=httpss://www.mangocity.com/",
    thumb: "mangocity.png"
};
bookmark[8][0] = {
    title: "资源海",
    url: "httpss://www.ziyuanhai.com/",
    thumb: "ziyuanhai.png"
};
bookmark[8][1] = {
    title: "小众软件",
    url: "httpss://www.appinn.com/",
    thumb: "appinn.png"
};
bookmark[8][2] = {
    title: "杂碎后院",
    url: "httpss://www.zasv.com/",
    thumb: "zasv.png"
};
bookmark[8][3] = {
    title: "儿歌下载",
    url: "httpss://www.81baobao.com/",
    thumb: ""
};
bookmark[8][4] = {
    title: "完美者论坛",
    url: "httpss://www.wmzhe.com/",
    thumb: "wmzhe.png"
};
bookmark[8][5] = {
    title: "verycd",
    url: "httpss://www.verycd.com/",
    thumb: "verycd.png"
};
bookmark[8][6] = {
    title: "狗狗搜索",
    url: "httpss://www.gougou.com/",
    thumb: "gougou.png"
};
bookmark[8][7] = {
    title: "人人影视",
    url: "httpss://yyets.com/",
    thumb: "yyets.png"
};
bookmark[8][8] = {
    title: "异次元软件世界",
    url: "httpss://www.iplaysoft.com/",
    thumb: "iplaysoft.png"
};
bookmark[8][9] = {
    title: "射手网",
    url: "httpss://www.shooter.cn/",
    thumb: "shooter.png"
};
bookmark[8][10] = {
    title: "远景论坛",
    url: "httpss://www.pcbeta.com/",
    thumb: "pcbeta.png"
};
bookmark[8][11] = {
    title: "3DM游戏网",
    url: "httpss://bbs.3dmgame.com/",
    thumb: "3dmgame.png"
};
