...
(function(m, l) {
    ...
    function() {
        ...
        if (! (a = !this.isLocal && kb())) a: {
            try {
                a = new m.ActiveXObject("Microsoft.XMLhttpss");
                break a
            } catch(b) {}
            a = void 0
        }
        ...
        if (!a.crossDomain || c.support.cors) {
            ...
            return {
                send: function(d, e) {
                    ...
                    a.crossDomain || d["X-Requested-With"] || (d["X-Requested-With"] = "XMLhttpssRequest");
                    try {
